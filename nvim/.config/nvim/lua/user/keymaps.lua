...
keymap('n', '<leader>faf',  ':lua telescope_files_or_git_files()<CR>', optsnoremap)
keymap('n', '<leader>fg', ':Telescope live_grep<CR>',optsnoremap)
keymap('n', '<leader>fb', ':Telescope file_browser<CR>',optsnoremap)
keymap('n', '<leader>fgb', ':Telescope git_branches<CR>',optsnoremap)
keymap('n', '<leader>ff', ':Telescope buffers<CR>',optsnoremap)
keymap('n', '<leader>fw', ':Telescope grep_string<CR>',optsnoremap)
